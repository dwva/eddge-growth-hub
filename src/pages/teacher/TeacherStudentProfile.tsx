...
const TeacherStudentProfileContent = () => {
  ...
  return (
    <div className="space-y-3 md:space-y-6 max-w-[1800px] pb-6 md:pb-8">
      {/* Header Navigation */}
      <div className="flex items-center gap-2 md:gap-3">
        ...
        <Button variant="outline" size="sm" className="gap-1.5 h-7 md:h-8 text-[10px] md:text-xs">
      ...
      {/* Student Header Card */}
      <Card className="border-0 shadow-lg rounded-xl md:rounded-2xl overflow-hidden bg-gradient-to-br from-primary/5 to-primary/10">
        <CardContent className="p-3 md:p-6">
          <div className="flex flex-col md:flex-row gap-3 md:gap-6">
            {/* Left: Avatar & Basic Info */}
            <div className="flex items-start gap-3 md:gap-4">
              <div className="relative">
                <Avatar className="w-12 h-12 md:w-16 md:h-16 border-2 md:border-4 border-white shadow-lg">
                  <AvatarFallback className="bg-primary text-white text-xs md:text-sm font-bold">
                    {studentProfile.avatar}
                  </AvatarFallback>
                </Avatar>
                <div className={`absolute -bottom-0.5 -right-0.5 md:-bottom-1 md:-right-1 w-4 h-4 md:w-5 md:h-5 rounded-full border-2 border-white ${getBehaviourStyle(studentProfile.behaviour)}`} />
              </div>
              <div>
                <h1 className="text-base md:text-xl font-bold text-gray-900 mb-0.5 md:mb-1">{studentProfile.name}</h1>
                <div className="space-y-0.5 text-[10px] md:text-xs text-gray-600">
                  <p>Roll: <span className="font-medium">{studentProfile.rollNumber}</span></p>
                  <p>Class: <span className="font-medium">10-A</span> | Rank: <span className="font-medium">#{studentProfile.rank}</span></p>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1 grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4">
              <div className="bg-white rounded-lg md:rounded-xl p-2.5 md:p-4 shadow-sm">
                <div className="flex items-center gap-1.5 md:gap-2 mb-1 md:mb-2">
                  ...
                  <span className="text-[9px] md:text-xs text-gray-500 uppercase">Overall</span>
                </div>
                <p className={`text-sm md:text-base font-bold ${getPerformanceColor(studentProfile.overallScore)}`}>
                ...
                <div className="flex items-center gap-1 mt-0.5 md:mt-1">
                  ...
                  <span className={`text-[9px] md:text-xs ${studentProfile.trendValue > 0 ? 'text-emerald-600' : 'text-red-600'}`}>
