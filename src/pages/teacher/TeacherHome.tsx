...
const navItems = [
  { label: 'Home', icon: <Home className="w-5 h-5" />, path: '/teacher' },
  { label: 'Classes', icon: <Users className="w-5 h-5" />, path: '/teacher/classes' },
  { label: 'Content', icon: <FolderOpen className="w-5 h-5" />, path: '/teacher/content' },
  { label: 'Homework', icon: <ClipboardList className="w-5 h-5" />, path: '/teacher/homework' },
  { label: 'Exams', icon: <FileQuestion className="w-5 h-5" />, path: '/teacher/exams' },
  { label: 'Analytics', icon: <BarChart3 className="w-5 h-5" />, path: '/teacher/analytics' },
  { label: 'Attendance', icon: <Calendar className="w-5 h-5" />, path: '/teacher/attendance' },
