...
import { superAdminApi, AuditLog, AccessLog, ComplianceLog } from '@/services/superAdminApi';
...
const SuperAdminSecurity = () => {
  ...
  const { data: auditData, isLoading: auditLoading } = useQuery({
    queryKey: ["superadmin", "audit-logs", auditPage, auditUserId],
    queryFn: () => superAdminApi.getAuditLogs(auditPage, 20, auditUserId || undefined),
  });

  const { data: accessData, isLoading: accessLoading } = useQuery({
    queryKey: ["superadmin", "access-logs", accessPage, accessUserId],
    queryFn: () => superAdminApi.getAccessLogs(accessPage, 20, accessUserId || undefined),
  });

  const { data: complianceData, isLoading: complianceLoading } = useQuery({
    queryKey: ["superadmin", "compliance-logs", compliancePage, complianceType],
